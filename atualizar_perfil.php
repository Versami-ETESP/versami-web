...
// A função validateImage deve estar disponível (em config.php ou neste arquivo).
// Supondo que ela esteja em config.php ou você a copie para cá.
/*
function validateImage($file, $maxSizeMB = 40, $minWidth = 100, $minHeight = 100, $maxWidth = 5000, $maxHeight = 5000) {
    // ... (código da validateImage) ...
    // Conteúdo da validateImage, caso precise copiar
