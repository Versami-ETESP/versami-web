    ...
    <body>
        ...
        <div class="modal-overlay" id="confirmationModalOverlay" onclick="cancelarDenuncia()">
            <div class="modal-content">
                <h2>Confirmar Denúncia</h2>
                <p>Você tem certeza que deseja denunciar esta publicação?</p>
                <div class="modal-actions">
                    <button id="cancelDenounceBtn" class="modal-btn cancel" onclick="cancelarDenuncia()">Cancelar</button>
